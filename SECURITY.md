...
Pagewright is early-stage local-first software for document processing.
...
Do not commit real user documents, credentials, private datasets, or generated files that could contain sensitive content. Use synthetic fixtures and sanitized examples only.
