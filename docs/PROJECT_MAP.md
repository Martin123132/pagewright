...
Before publishing larger changes, review `docs/COMMIT_READINESS.md`, `docs/PUBLIC_PROOF.md`, `docs/RELEASE_READINESS.md`, `docs/RELEASE_REVIEW_OUTCOME_TEMPLATE.md`, `CONTRIBUTING.md`, and `SECURITY.md`.
