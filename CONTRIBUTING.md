...
Thanks for helping make everyday document tools free, local-first, and open.
...
Please keep changes focused, include tests for behavior changes, and update docs when user-facing setup or workflows change.
